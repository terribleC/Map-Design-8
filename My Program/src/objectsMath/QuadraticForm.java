...
public class QuadraticForm {
	...
	public QuadraticForm(String nonRadical, String radical, String denominator) {
		...
		BufferedImage sample = new BufferedImage(100, 100,
		...
		int nonRadicalWidth = g.getFontMetrics().stringWidth(
				nonRadical + " + √");
		...
		g2.drawString(denominator, (width - denominatorWidth) / 2, fontDip + 2
				* fontHeight);
		...
		if (expInsert != 0)
			g2.drawString(2 + "", expInsert, expHeight + 3);
